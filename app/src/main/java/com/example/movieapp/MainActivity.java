...
public class MainActivity extends AppCompatActivity {
    ...
    String sort = Util.SORTING_POPULARITY_DESC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switcher.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (!movies.isEmpty() && !switcher.isChecked()){
                    ...
                    sort = Util.SORTING_POPULARITY_DESC;
                    loadMovies(sort);
                    adapter.notifyDataSetChanged();
                }
            }
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                MainActivity.this.loadMovies(sort);
            }
        });
    }
    ...
    private void loadMovies(String sort) {
        ...
        Call<ApiResponseDiscover> request = api.getMovies(Util.API_KEY, Util.LANGUAGE, sort, false, false);
        request.enqueue(new Callback<ApiResponseDiscover>() {
            @Override
            public void onResponse(Call<ApiResponseDiscover> call, Response<ApiResponseDiscover> response) {
            ...
            @Override
            public void onFailure(Call<ApiResponseDiscover> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
